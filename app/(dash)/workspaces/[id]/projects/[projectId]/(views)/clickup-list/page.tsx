...
export default function ClickUpListView({ params }: { params: { id: string; projectId: string } }) {
    ...
    const loadData = async () => {
      try {
        ...
        if (tasksResponse.ok) {
          ...
          setTasks(tasksData)
          console.log('✅ Tasks loaded for project:', tasksData)
        } else {
  ...
  }, [user, params.id, params.projectId])
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">
                  {getClientName(params.projectId, clients)}
                </h1>
                <p className="text-sm text-gray-600">
                  {stats.total} tareas • {users.length} miembros
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => router.push(`/workspaces/${params.id}/projects/${params.projectId}/kanban`)}
                >
